							...
							return (
								<li class="media-item my-5" data-lang={item.lang ?? 'ja'}>
									<h3 class="op-card text-xl transition-base">
										<a class="underline" href={item.link} rel="noopener noreferrer" target="_blank">
											{item.title}
										</a>
									</h3>
									<p class="opacity-50">
										<span class={`${details.icon} mr-1`} aria-hidden="true" />
										{details.label}
										<time class="truncate pl-2 text-sm opacity-80" datetime={item.pubDate}>
