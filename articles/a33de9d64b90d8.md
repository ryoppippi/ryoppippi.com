...
- 言語ごとのパッケージマネージャー
  ...
  - [cargo](https://doc.rust-lang.org/cargo/) - Rustのパッケージマネージャー。Rustのツールを管理するのに使う
...
- パッケージマネージャーの設定をDeclaretiveに記述できる
- パッケージマネージャがー管理するツールの設定やバージョンをDeclaretiveに記述できる
...
このパッケージマネージャーはAquaと同じくYAMLでDeclaretiveにツールを管理できます。
