...
- OSS projects: `/src/contents/works/oss/list.json` - Curated, manually ordered, tagged list of GitHub projects; optional `kind: "contribution"` marks external upstream work
- OSS star snapshot: `/src/contents/works/oss/stars.json` - Generated by `/.github/update-oss-stars.nu`
