...
<details>
<summary>git commit実行時のhookの実行順序</summary>
...
<details>
<summary>git hooks の設定について</summary>
...
![git config --global commit.verbose false](./0.png)
_`git config --global commit.verbose false` の場合_
![git config --global commit.verbose true](./1.png)
